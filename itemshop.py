...
class Athena:
    ...
    def GenerateImage(self, date: str, itemShop: dict):
        ...
        textWidth, _ = font.getsize("")
        canvas.text(ImageUtil.CenterX(self, textWidth, shopImage.width, 30), "", (255, 255, 255), font=font)
        ...
        if itemShop["featured"] is not None:
            canvas.text((20, 240), "Destacado", (255, 255, 255), font=font, anchor=None, spacing=4, align="left")

        if itemShop["daily"] is not None:
            canvas.text((shopImage.width - 230, 240), "Diario", (255, 255, 255), font=font, anchor=None, spacing=4, align="right")
    ...
    def Tweet(self, date: str):
        ...
        body = f"Nueva Tienda #Fortnite: {date}"
